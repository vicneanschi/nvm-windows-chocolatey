...
$packageName= 'nvm-windows' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'nvm-windows*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = ''
